...
| `mxheadless.max_limit` | 100 | Max `limit` on list endpoints |
| `mxheadless.max_offset` | 100000 | Max `offset` (and derived page offsets) |
| `mxheadless.max_fields` | 50 | Max comma-separated `fields` |
